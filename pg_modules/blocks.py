...
class CommLayer(nn.Module):
    def __init__(self, 
        ...
        if comm_type in ['mean', 'sharpen']:
            self.conv = CommConv2d(comm_type, kernel_size=win_size, normalized=normalized)
        else:
